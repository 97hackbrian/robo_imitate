...
def plot_action_trajectory(sim, positions1, positions2=None):
    ...
    sc1 = ax.scatter(positions1[:, 0], positions1[:, 1], positions1[:, 2],
                     c=colors1, marker='o', s=50, alpha=0.8,
    ...
    if positions2 is not None:
        ...
        sc2 = ax.scatter(positions2[:, 0], positions2[:, 1], positions2[:, 2],
                         c=colors2, marker='^', s=50, alpha=0.8,
                         edgecolor='k', linewidth=0.5,
    ...
    ax.set_title('Observation vs. Action Trajectory (3D)', fontsize=14, fontweight='bold')
